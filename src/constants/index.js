...
const projects = [
    ...
    {
    name: "Disaster-Aware Intelligent Routing System",
    description:
        "Java-based backend system integrating Random Forest ML models and Groq LLM to compute safe routes using real-time disaster risk analysis and intelligent routing.",
    tags: [
        {
            name: "Java",
    ...
    image: roadmanagement, // replace with your image variable name
    source_code_link: "https://github.com/Ashu09032005/Road_Management",
},
    {
    name: "CarePoint - Maintenance Management System",
    description:
        "A full-stack maintenance portal enabling efficient service request tracking with role-based access, secure authentication, and automated notifications.",
    tags: [
        {
            name: "Node.js",
            color: "blue-text-gradient",
    ...
    image: carepoint, // make sure you add carepoint.png in assets and export it
    source_code_link: "https://github.com/Ashu09032005/Carepoint",
},
    {
